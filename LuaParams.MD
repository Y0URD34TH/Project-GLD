...
## Some working scripts example can be found here: https://github.com/Y0URD34TH/Project-GLD/tree/main/Scripts
...
* [menu](#namespace-menu)
* [http](#namespace-http)
* [Installation](#namespace-utils)
* [utils](#namespace-communication)
* [file](#namespace-file)
...
```lua
function communication.receiveSearchResults(resultsTable: table)
```
Receives search results from a table and processes them.

#### Parameters:
- `resultsTable` (table): A table containing search results.

#### Usage Example:
```lua
local results = {
    { name = "Result 1", link = "https://example.com/result1", addtoDownloadlist = true, ScriptName = "Script 1" },
    { name = "Result 2", link = "https://example.com/result2", addtoDownloadlist = false, ScriptName = "Script 2" },
}
...
```
## to know how to use lua, please check the original lua documentation here: https://www.lua.org/docs.html
