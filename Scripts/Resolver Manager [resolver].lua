local VERSION = "1.0"
client.auto_script_update("https://raw.githubusercontent.com/Y0URD34TH/Project-GLD/refs/heads/main/Scripts/Resolver%20Manager%20%5Bresolver%5D.lua", VERSION)
...
local function check_and_download_resolvers()
    ...
    for _, resolver in ipairs(resolvers) do
        ...
        if not file.exists(full_path) then
            ...
            sleep(500) -- Small delay between downloads
        else
