...
if scriptname == "1click-alternative" then
...
Notifications.push_warning("2clicks Script", "Please got to the library and modify the game path!")
end
end
