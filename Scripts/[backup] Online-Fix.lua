local VERSION = "1.0.0"
client.auto_script_update("https://raw.githubusercontent.com/Y0URD34TH/Project-GLD/refs/heads/main/Scripts/%5Bbackup%5D%20Online-Fix.lua", VERSION)
local sourcelink = "https://hydralinks.pages.dev/sources/onlinefix.json"
