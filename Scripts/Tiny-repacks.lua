local VERSION = "1.0.0"
client.auto_script_update("https://raw.githubusercontent.com/Y0URD34TH/Project-GLD/refs/heads/main/Scripts/Tiny-repacks.lua", VERSION)
local sourcelink = "https://hydralinks.pages.dev/sources/tinyrepacks.json"
